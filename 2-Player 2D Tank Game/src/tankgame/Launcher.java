...
import tankgame.menus.EndGame;
import tankgame.menus.StartMenu;
...
public class Launcher {
    ...
    private JPanel tank1;
    private JPanel tank2;
    /*
    ...
    private void initUIComponents() {
        ...
        this.startPanel = new StartMenu(this); // create a new start panel
        this.gamePanel = new TRE(this); // create a new game panel
        this.gamePanel.gameInitialize(); // initialize game, but DO NOT start game
        this.endPanel = new EndGame(this); // create a new end game pane;
        this.tank1 =  new EndGame(this);
        this.tank2 =  new EndGame(this);
        ...
        this.mainPanel.add(tank1, "tank1");
        this.mainPanel.add(tank2, "tank2");
    ...
    public void setFrame(String type) {
        ...
        switch (type) {
            ...
            case "tank1" -> {
                this.jf.setSize(GameConstants.END_MENU_SCREEN_WIDTH, GameConstants.END_MENU_SCREEN_HEIGHT);
                this.jf.setTitle("TANK 1 WON!");
            }

            case "tank2" -> {
                this.jf.setSize(GameConstants.END_MENU_SCREEN_WIDTH, GameConstants.END_MENU_SCREEN_HEIGHT);
                this.jf.setTitle("TANK 2 WON!");
            }
        }
